...
class OpenAIAPI:
    ...
    def api_call(self, model, system_prompt, prompt, response_format, temperature, top_p, max_completion_tokens, presence_penalty, frequency_penalty, openai_api_key):
        if prompt == "" or prompt == "exit" or prompt is None:
            return (None, )
